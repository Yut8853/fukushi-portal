...
const CONTENT: Record<string, SeoCategoryContent> = {
  food: {
    ...
    summary: "今日や数日以内の食事に困っているときは、食料支援だけでなく、生活全体を一緒に整理できる窓口へ相談できます。",
  ...
  rent: {
    ...
    firstAction: "督促状や賃貸借契約書が手元になくても相談できます。退去期限があれば先に伝えてください。",
    relatedTerms: ["家賃滞納", "住居確保給付金", "退去相談"],
  },
  utilities: {
    searchTitle: "電気・ガス・水道が止まりそう",
    summary: "公共料金を払えないときは、電気・ガス会社への支払い相談と、水道料金を扱う自治体・水道局への相談で連絡先が異なります。",
    firstAction: "停止予定日が書かれた通知があれば、その日を最初に伝えてください。",
    relatedTerms: ["電気代が払えない", "ガス代滞納", "水道料金相談"],
  },
  money: {
    searchTitle: "生活費がない・お金がなく生活できない",
    summary: "生活費が尽きた、収入がなく暮らせないときに、生活保護や生活困窮相談へつながる窓口を案内します。",
    firstAction: "所持金が少ない、食事や住まいにも困っている場合は、その緊急性を最初に伝えてください。",
    relatedTerms: ["生活保護相談", "生活費がない", "公的支援"],
  },
  medical: {
    searchTitle: "病院に行くお金がない・医療費が払えない",
    summary: "受診費用や保険料、医療費の支払いが難しいときに利用できる可能性がある相談先を案内します。",
    firstAction: "強い痛みや呼吸困難など緊急性がある場合は、相談窓口ではなく119番を利用してください。",
  ...
  debt: {
    ...
    summary: "借金、督促、給料や口座の差し押さえが心配なときに、生活と支払いを一緒に整理する入口です。",
    firstAction: "請求書が全部そろっていなくても相談できます。裁判所から届いた書類には期限があるため、その有無を伝えてください。",
    relatedTerms: ["借金相談", "督促", "債務整理"],
  },
  violence: {
    searchTitle: "DV・家族や同居人から逃げたい",
    summary: "家族や同居人からの暴力や支配から離れたいときの安全な相談先です。自治体の代表電話は表示しません。",
    firstAction: "画面を見られる危険がある場合は「すぐ閉じる」を使い、安全な端末から相談してください。",
    relatedTerms: ["DV相談", "避難相談", "配偶者暴力"],
  },
  children: {
    searchTitle: "子ども・妊娠・ひとり親の生活相談",
    summary: "子育て、妊娠、就学、ひとり親家庭の生活やお金に関する地域の相談入口です。",
    firstAction: "子どもの安全に差し迫った心配がある場合は、児童相談所虐待対応ダイヤル189へ相談できます。",
